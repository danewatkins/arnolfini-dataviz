...
<body>
  <div id="wrapper">
    ...
    <div id="left-text" style="top:370px;left:55px;" >
      <div id="percent" style="left:80px;">
        <img class="txt1" style="height:70px;top:0px;left:0px;" src="images/<?php echo $relevanceNumbers[0] ?>.gif">
        <img class="txt1" style="height:70px;top:0px;left:40px;" src="images/<?php echo $relevanceNumbers[1]  ?>.gif">
        <img class="txt" style="height:50px;top:5px;left:100px;" src="images/percent.gif">
      </div>
      <img class="txt" style="height:25px;top:65px;left:30px;" src="images/average.gif">
    </div>
    ...
    <div id="right-text" style="top:370px;left:465px;" >
      <div id="percent2" style="left:80px;">
        ...
        <img class="txt1" style="height:70px;top:0px;left:40px;" src="images/<?php echo $presentationNumbers[1] ?>.gif">
        <img class="txt" style="height:50px;top:5px;left:100px;" src="images/percent.gif">
      </div>
      <img class="txt" style="height:25px;top:65px;left:30px;" src="images/average.gif">
    </div>
