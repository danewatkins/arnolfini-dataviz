...
<body>
  <div id="wrapper">
    ...
    <div id="left-text" style="top:375px;left:50px;" >
      ...
      <img class="txt" style="top:55px;left:0px;" src="images/average.gif">
    </div>
    <!-- RIGHT  -->
    <img id="right-arrow" style="transform:rotate(<?php echo $challengeDegrees ?>deg);" src="images/challenge-arrow.gif">
    <div id="right-text" style="top:375px;left:460px;" >
      <div id="percent2" style="left:0px;">
        <img class="txt1" style="height:70px;top:0px;left:10px;" src="images/<?php echo $challengeNumbers[0] ?>.gif">
